...
import UIKit
import CoreData
class FriendListVC: UIViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate, SWTableViewCellDelegate {
    ...
    //Table View & UITextField methods
